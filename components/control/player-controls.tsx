...
function VolumeSlider({ musicManager }: { musicManager: MusicManager }) {
  ...
  const [previousVolume, setPreviousVolume] = useState(() => musicManager.getVolume());
  ...
  const handleVolumeIconClick = () => {
    if (value > 0) {
      ...
      setValue(restoreVolume);
      musicManager.setVolume(restoreVolume);
    }
  };
  ...
  return (
    <>
      <button
        ...
        className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 rounded"
